    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程原价" prop="kechengOldMoney">
                       <el-input v-model="ruleForm.kechengOldMoney"
                                 placeholder="课程原价" clearable  :readonly="ro.kechengOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="课程原价" prop="kechengOldMoney">
                           <el-input v-model="ruleForm.kechengOldMoney"
                                     placeholder="课程原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.kechengOldMoney = true;
                this.ro.kechengNewMoney = true;
            }
